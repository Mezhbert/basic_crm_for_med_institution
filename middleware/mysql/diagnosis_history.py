...
# класс для работы с mysql с таблицей medical_records для истории диагнозов
class DiagnosisHistory(metaclass=Singleton):
    def __init__(self, db, cursor):
        ...
        self.m_sql = Sql(os.path.join(parent_path, "sql/diagnosis_history.sql"))
